...
public class MappedEntity {
    ...
    public MappedEntity(final Long age, final int faves, final String name, final String fullName) {
        this.age = age;
        this.faves = faves;
        this.name = name;
    ...
    public void setFaves(final int faves) {
        this.faves = faves;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final MappedEntity entity = (MappedEntity) o;
