...
import static org.bson.codecs.configuration.mapper.FieldModel.extract;
    ...
    public void testExtract() {
        ...
        for (ResolvedField field : fields) {
            if("tripleList".equals(field.getName())) {
                ...
                compare(extract(field.getType()), Arrays.<Class>asList(HashMap.class, HashMap.class, HashMap.class, BaseGenericType.class));
